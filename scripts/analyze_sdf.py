"""Analyze molecular properties and metadata from an SDF file."""
...
def analyze_sdf(sdf_path, n_samples=1000):
    """Print molecular property statistics from an SDF file.

    Input:
        sdf_path: path to the SDF file.
        n_samples: max molecules to analyze in detail (default 1000).
    Output:
